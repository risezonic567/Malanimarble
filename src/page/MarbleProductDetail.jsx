    ...
    return (
        <section className="min-h-screen bg-white font-sans text-slate-800">
            <Helmet>
                ...
                <link
                    rel="canonical"
                    href={`https://www.malanimarbles.com/marble-collection/${category.slug}/${product.slug}`}
                />
            </Helmet>
            ...
            <div className="max-w-7xl mx-auto px-6 py-10">
                ...
                <nav className="text-sm text-gray-500 mb-8 flex items-center gap-2">
                    ...
                    <span>/</span>
                    <Link to={`/marble-collection/${category.slug}`} className="hover:text-black transition">
                        {category.name}
                    </Link>
                    <span>/</span>
                ...
                {relatedProducts && relatedProducts.length > 0 && (
                    <div className="mt-24 pt-10 border-t border-gray-200">
                        <div className="flex justify-between items-end mb-8">
                            ...
                            <Link
                                to={`/marble-collection/${category.slug}`}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                            {relatedProducts.map((relProduct) => (
                                <Link
                                    key={relProduct.slug}
                                    to={`/marble-collection/${category.slug}/${relProduct.slug}`}
